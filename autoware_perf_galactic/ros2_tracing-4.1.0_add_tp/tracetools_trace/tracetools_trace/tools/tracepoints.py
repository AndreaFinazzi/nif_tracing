...
#rei >>>>>>>>>>>>>>>>>>>>>>>>>>>>.
rclcpp_subscribe = 'ros2:rclcpp_subscribe'
client_request = 'ros2:client_request'
service_request = 'ros2:service_request'
service_response = 'ros2:service_response'
client_response = 'ros2:client_response'
#rei >>>>>>>>>>>>>>>>>>>>>>>>>>>>.